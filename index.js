...
export const newsletter = [
	{
		...
		title: 'Jonell Samara',
		link: 'https://www.linkedin.com/in/jonell-samara-8b475b2a8/',
...
export const author_info = [
	...
	},
	{
		...
		role: '',
		year: '',
		desc1: "Trying to speedrun her 4th year of Mechanical Engineering here at IITT, Sneha has been a part of Udaan since her first year and is now one of the Editors-in-Chief. She spent her teenage years starry-eyed and writing letters for people she loves. A mistress of delusion and precise overthinking, she takes pride in her capacity to sleep on the lounge sofas and her ability to smell like vanilla cupcakes. Always open to a good anime, kdrama, or philosophy, provided her attention span does not dissipate.",
		desc2: '',
	...
	},
	{
		...
		role: '',
		year: '',
		desc1: "Neerav defines himself as the sanest chaos out there pursuing Chemical Engineering at IIT Tirupati.  Married at the age of 11 to FC Bayern, his football rants (unconditional love ahem) can be heard everywhere in the campus making him the ideal husband 'husband' material. Apart from being a 'meat-nificent' eater, he is a Tarantino fanboy- loves every 'sole' in his 'foot-tastic' movies; no offence Quentin!  Though he has been found cheating SEVERAL TIMES on Tarantino with Fincher and 90s Mammootty Mollywood films, we guess that doesn't count as a punishable offence, does it?",
		link: '',
	},
	{
		key: 'rajat',
	...
	},
	{
		...
		role: '',
		year: '',
		desc1: "If you ever see a person following a cat into a dingy place thats Aadhya. Half of her personality is inspired from a cat and the other is that of a stone. She likes to write heavy poetry as a way of expression and communicates using stickers. She's curious and stressed, so if you ever find her with a dramatic expression on her face - its probably one of the two. She plays basketball, bakes desserts and reads a bit for her \"me\" time.",
		desc2: '',
		link: '',
	},
	{
	...
	},
	{
		...
		role: '',
		year: '',
		desc1: "Palak is a final-year Chemical Engineering student at IIT Tirupati who prefers to live in her own little world — and honestly, we respect that. Often looking deep in thought (and occasionally confused), people think she’s dead serious, but really, she’s just plotting her next watercolour masterpiece or deciding which angle would make a better photo. A momo enthusiast and a part-time philosopher, she loves writing down her thoughts — because why keep all that brilliance in her head? Funny, thoughtful, and sometimes unintentionally mysterious, Palak is equal parts chill and chaos.",
		desc2: '',
		link: '',
	}
];