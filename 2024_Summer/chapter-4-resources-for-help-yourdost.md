...
3. Ensuring Quality with Scale: We started our journey with a handful of clients and have worked with over 600+ clients in the last nine years. Ensuring that we retained the same level of quality with our counseling sessions, pieces of training, and programs was a challenge at first, but we solved it by ensuring regular check-ins and surveys with our clientele so that the quality is not lost at scale
4. How YourDost works Given that mental health assistance or therapy is typically expensive, how does YourDost manages to provide these services at a much more affordable rate.

A: Quality professional mental health support can become quite expensive in India. A therapy session can cost Rs 800-2,500 per session, and it can take up to three months of weekly sessions for therapy to be effective. 
...
To tackle this, YourDOST has tied up (through formal MoUs) with colleges, corporates, schools, government bodies etc. In these collaborations, the institution subscribes to YourDOST, and their community (students/ working professionals/ staff) can access counseling services for FREE. 

6. How does the whole business model work? Where do you get people? Are they employed

on a full-time basis or part-time and so on?

A: At YourDOST, we work with organizations, colleges, corporates and schools and provide intevention on three levels.
...
* At the organization level, we work with the leadership on strategy, diagnostics, and awareness.
...
7. What do you think is the main issue regarding mental health in India, as it is widely

known that we don’t pay enough attention to it? What might be the reason behind it?

A: Mental health in India faces severe stigma, where it is still a taboo, preventing many from seeking help. 

The healthcare system prioritizes physical health, leaving mental health underfunded and under-resourced, especially in rural areas. Access to mental health services is limited for those in smaller cities and remote areas, and the traditional offline model doesn't offer 24/7 support. However, technology has introduced the concept of 24/7 mental health support, providing users with access to psychologists according to their needs.

8. Is YourDost currently involved in diagnosing mental illnesses, or does it only offer

therapy sessions? What are the current features available?

A: At YourDOST, we have a team of 1000+ experts, including Psychologists, Career Coaches, and Life Coaches.

Among our other offerings, we have a program for first-time managers, maternity support, retrenchment support, holistic wellness (physical and financial), career counseling, school mental health, etc.

With our platform, we also plan to expand collaborations with organizations and government projects, focusing on personalized care and addressing root causes rather than just stress management. 

Miscellaneous

9. In terms of impact, do you think therapy is as vital as self-growth or recreational

activities like yoga, mindfulness and so on.
...
A: As we look towards the future, YourDOST is poised to navigate the dynamic landscape of Indian healthcare startups with a clear vision. Our primary goal is to extend our reach to all regions of India, ensuring that no individual is left without access to quality mental health support. We aim to cater to a diverse array of organizations, transcending traditional boundaries to include every sector that can benefit from our services.

In the coming years, we envision YourDOST becoming synonymous with mental wellness in India. By embracing innovation, fostering inclusivity, and prioritizing the needs of our community, we are committed to transforming the landscape of mental health care in India and setting a new standard for healthcare startups globally.
